...
[[maybe_unused]] void testRussianMapObjectivesFitInsideInformationPanel() {
...
[[maybe_unused]] void testCompoundRussianMenuLocalization() {
  sf::game::setGameLanguage(sf::game::GameLanguage::russian_vit);
...
[[maybe_unused]] void testProofreadRussianCampaignTextIsBuiltIn() {
...
[[maybe_unused]] void testFormattedMissionLocalization() {
  sf::game::setLocalizationRoot({});
  sf::game::setGameLanguage(sf::game::GameLanguage::russian_vit);
...
[[maybe_unused]] void testMissionMenuLocalizationDoesNotLeakAcrossLanguages() {
  const std::vector<std::string> objectives{
      "Eliminate Kravitch and destroy comm. array",
      "Protect CBDC bomb squad",
  };
