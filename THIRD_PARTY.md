...
This source snapshot deliberately excludes character artwork, dossier images,
localized game assets, translated game text and other data derived from a game
image. No rights to *Syphon Filter*, its characters, artwork or trademarks are
granted.
