...
[[nodiscard]] HorizontalDirection headingDirection(std::int32_t heading) noexcept;
...
[[nodiscard]] CameraRay cameraRayAtProjectionOffset(
...
public:
    explicit FirstPersonCamera(FirstPersonCameraConfiguration configuration = {}) noexcept;

    [[nodiscard]] CameraState view(
        double x,
        double y,
        double z,
        std::int32_t heading,
