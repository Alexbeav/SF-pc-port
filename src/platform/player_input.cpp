...
constexpr std::array<KeyboardMouseActionDescriptor, keyboard_mouse_action_count>
    keyboard_mouse_actions{{
        ...
        {"Turn Left", "TurnLeft", KeyboardMouseInput::q},
        {"Turn Right", "TurnRight", KeyboardMouseInput::e},
        {"Strafe Left", "StrafeLeft", KeyboardMouseInput::a},
        {"Strafe Right", "StrafeRight", KeyboardMouseInput::d},
